...
public class Main {
    ...
    public static boolean checkForPassword(String str, int minLength) {
        if (str == null || str.isEmpty() || str.length() < minLength)
            return false;
        final boolean digit = Pattern.matches(".*[0-9].*", str);
    ...
    // 1. Ends with "@mail.utoronto.ca" or "@utoronto.ca"
    // 2. Has a (i.e. at least one) character before the @
    ...
    // Condition:
    // The same capital letter occurs twice in the string
